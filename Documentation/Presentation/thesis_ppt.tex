...
\author{Supervisor: Prof. T.K Srikanth \;\;\;\;\;\;\;\;\; Srinivas R. Vaidya (MT2013152)} % Your name
...
\medskip
\textit{srinivas.r.vaidya@iiitb.org} % Your email address
}
...
\item We use a ray tracing approach, which is implemented on GPU shaders to enable interactive response.
