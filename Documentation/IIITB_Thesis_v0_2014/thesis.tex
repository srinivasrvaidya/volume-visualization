...
\renewcommand{\thesistitle}{VISIBILITY DRIVEN FOCUS+CONTEXT VISUALIZATION OF MULTIMODAL VOLUME DATA}
...
\renewcommand{\authorname}{Srinivas R. Vaidya}
\renewcommand{\rollnumber}{MT2013152}
